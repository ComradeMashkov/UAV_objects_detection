...
if __name__ == '__main__':
    ...
    split = splitbase(os.path.join(filedir,'..','dataset','train'),
                       os.path.join(filedir,'..','dataset','trainsplit'),
                      gap=200,
                      subsize=1024,
                      num_process=8
                      )
    ...
    split = splitbase(os.path.join(filedir,'..','dataset','val'),
                       os.path.join(filedir,'..','dataset','valsplit'),
                      gap=200,
                      subsize=1024,
                      num_process=8
                      )
